...
function Kavo.CreateLib(kavName, themeList)
    ...
    Main.Parent = ScreenGui
            ...
            if Main:FindFirstChild("UIStroke") then
                Main:FindFirstChild("UIStroke").Color = themeList.SchemeColor
            end
    ...
    function Tabs:NewTab(tabName)
        ...
        local function UpdateSize()
            ...
            game.TweenService:Create(page, TweenInfo.new(0.15, Enum.EasingStyle.Quint, Enum.EasingDirection.In), {
        ...
        coroutine.wrap(function()
            ...
            function Elements:NewButton(bname,tipINf, callback)
                ...
                btn.MouseEnter:Connect(function()
                    if not focusing then
                        game.TweenService:Create(btn, TweenInfo.new(0.1, Enum.EasingStyle.Quint, Enum.EasingDirection.In), {
                    ...
                    btn.MouseButton1Click:Connect(function()
                        if not focusing then
                            if toggled == false then
                                game.TweenService:Create(img, TweenInfo.new(0.11, Enum.EasingStyle.Quint,Enum.EasingDirection.In), {
                                    ImageTransparency = 0
                                }):Play()
                                local c = sample:Clone()
                                c.Parent = btn
            ...
            function Elements:NewSlider(slidInf, slidTip, maxvalue, minvalue, callback)
                ...
                val.FocusLost:Connect(function(enterPressed)
                    if enterPressed then
                        ...
                        if num then
                            num = math.clamp(num, tonumber(minvalue), tonumber(maxvalue))
                            Value = num
                            val.Text = tostring(num)
                            local percent = (num - tonumber(minvalue)) / (tonumber(maxvalue) - tonumber(minvalue))
                            sliderDrag:TweenSize(UDim2.new(0, math.clamp(149 * percent, 0, 149), 0, 6), "InOut", "Quint", 0.2, true)
                            pcall(function()
                                callback(Value)
                            end)
                        else
                ...
                sliderBtn.MouseButton1Down:Connect(function()
                    if not focusing then
                        game.TweenService:Create(val, TweenInfo.new(0.1, Enum.EasingStyle.Quint, Enum.EasingDirection.In), {
                            TextTransparency = 0
                        }):Play()
            ...
            function Elements:NewDropdown(dropname, dropinf, list, callback)
                ...
                for i,v in next, list do
                    ...
                    optionSelect.MouseEnter:Connect(function()
                        if not focusing then
                            game.TweenService:Create(optionSelect, TweenInfo.new(0.1, Enum.EasingStyle.Quint, Enum.EasingDirection.In), {
                                BackgroundColor3 = Color3.fromRGB(themeList.ElementColor.r * 255 + 8, themeList.ElementColor.g * 255 + 9, themeList.ElementColor.b * 255 + 10)
                            }):Play()
                            oHover = true
                        end 
            ...
            function Elements:NewKeybind(keytext, keyinf, first, callback)
                ...
                keybindElement.MouseEnter:Connect(function()
                    if not focusing then
                        game.TweenService:Create(keybindElement, TweenInfo.new(0.1, Enum.EasingStyle.Quint, Enum.EasingDirection.In), {
                            BackgroundColor3 = Color3.fromRGB(themeList.ElementColor.r * 255 + 8, themeList.ElementColor.g * 255 + 9, themeList.ElementColor.b * 255 + 10)
                        }):Play()
                        oHover = true
                    end 
            ...
            function Elements:NewColorPicker(colText, colInf, defcolor, callback)
                ...
                colorElement.MouseEnter:Connect(function()
                    if not focusing then
                        game.TweenService:Create(colorElement, TweenInfo.new(0.1, Enum.EasingStyle.Quint, Enum.EasingDirection.In), {
                            BackgroundColor3 = Color3.fromRGB(themeList.ElementColor.r * 255 + 8, themeList.ElementColor.g * 255 + 9, themeList.ElementColor.b * 255 + 10)
                        }):Play()
                        hovering = true
                    end 
                ...
                local function togglerainbow()
                    if rainbow then
                        game.TweenService:Create(toggleEnabled, TweenInfo.new(0.1, Enum.EasingStyle.Quint, Enum.EasingDirection.InOut), {
                            ImageTransparency = 1
                        }):Play()
                        rainbow = false
            ...
            function Elements:NewParagraph(title, text)
                ...
                paragraph.Parent = sectionInners
                paragraph.BackgroundColor3 = themeList.ElementColor
                paragraph.BorderSizePixel = 0
                paragraph.ClipsDescendants = true
                paragraph.Size = UDim2.new(0, 352, 0, 60)
                ...
                pTitle.Position = UDim2.new(0.0198863633, 0, 0.05, 0)
                pTitle.Size = UDim2.new(0.98, 0, 0, 20)
                pTitle.Font = Enum.Font.GothamSemibold
                pTitle.Text = title
                pTitle.RichText = true
                pTitle.TextColor3 = themeList.SchemeColor
                pTitle.TextSize = 14.000
                pTitle.TextXAlignment = Enum.TextXAlignment.Left
                
                pText.Name = "pText"
                pText.Parent = paragraph
                pText.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
                pText.BackgroundTransparency = 1.000
                pText.Position = UDim2.new(0.0198863633, 0, 0.45, 0)
                pText.Size = UDim2.new(0.96, 0, 0, 30)
                pText.Font = Enum.Font.Gotham
                pText.Text = text
                pText.TextColor3 = themeList.TextColor
                ...
                local bounds = pText.TextBounds
                if bounds.Y > 30 then
                    paragraph.Size = UDim2.new(0, 352, 0, 30 + bounds.Y + 10)
                    pText.Size = UDim2.new(0.96, 0, 0, bounds.Y)
                end
                ...
                function paragraphFunctions:UpdateParagraph(newTitle, newText)
                    pTitle.Text = newTitle
                    pText.Text = newText
                    local newBounds = pText.TextBounds
                    if newBounds.Y > 30 then
                        paragraph.Size = UDim2.new(0, 352, 0, 30 + newBounds.Y + 10)
                        pText.Size = UDim2.new(0.96, 0, 0, newBounds.Y)
                    else
                        paragraph.Size = UDim2.new(0, 352, 0, 60)
                        pText.Size = UDim2.new(0.96, 0, 0, 30)
                    end
            ...
            function Elements:NewImage(title, imageId, height)
                ...
                imageFrame.Parent = sectionInners
                imageFrame.BackgroundColor3 = themeList.ElementColor
                imageFrame.BorderSizePixel = 0
                imageFrame.ClipsDescendants = true
                imageFrame.Size = UDim2.new(0, 352, 0, height + 35)
                
                UICorner.CornerRadius = UDim.new(0, 4)
                UICorner.Parent = imageFrame
                
                pTitle.Name = "pTitle"
                pTitle.Parent = imageFrame
                pTitle.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
                pTitle.BackgroundTransparency = 1.000
                pTitle.Position = UDim2.new(0.0198863633, 0, 0.05, 0)
                pTitle.Size = UDim2.new(0.98, 0, 0, 20)
                ...
                pTitle.Text = title
                pTitle.RichText = true
                pTitle.TextColor3 = themeList.TextColor
                pTitle.TextSize = 14.000
                pTitle.TextXAlignment = Enum.TextXAlignment.Left
                ...
                img.Size = UDim2.new(0, 332, 0, height)
                img.Image = imageId
                ...
                function imageFunctions:UpdateImage(newImageId)
    ...
    function Kavo:Notify(title, text, duration)
        ...
        frame.BackgroundColor3 = Color3.fromRGB(36, 37, 43)
        ...
        uistroke.Color = Color3.fromRGB(74, 99, 135)
        ...
        coroutine.wrap(function()
            local t = themes or {Background = Color3.fromRGB(36, 37, 43), SchemeColor = Color3.fromRGB(74, 99, 135), TextColor = Color3.fromRGB(255,255,255)}
            while notifyGui.Parent and wait() do
                frame.BackgroundColor3 = t.Background or Color3.fromRGB(36, 37, 43)
                uistroke.Color = t.SchemeColor or Color3.fromRGB(74, 99, 135)
                titleLabel.TextColor3 = t.SchemeColor or Color3.fromRGB(74, 99, 135)
                textLabel.TextColor3 = t.TextColor or Color3.fromRGB(255, 255, 255)
            end
        end)()
        
        game.TweenService:Create(frame, TweenInfo.new(0.5, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {
            Position = UDim2.new(1, -20, 1, -20)
        }):Play()
        
        task.delay(duration or 3, function()
            local tw = game.TweenService:Create(frame, TweenInfo.new(0.5, Enum.EasingStyle.Quint, Enum.EasingDirection.In), {
